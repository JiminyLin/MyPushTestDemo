...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [JPUSHService startLogPageView:@"setLocalNotification"];
    [self curTime];
    NSLog(@" 进入 setLocalNotification 页面：%@",dateString );
    
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [JPUSHService stopLogPageView:@"setLocalNotification"];
    [self curTime];
    NSLog(@" 离开 setLocalNotification 页面：%@",dateString );
